...
const allProjects: Project[] = [
  ...
  },
  {
    ...
    description: {
      fr: [
        "Les outils qui transforment une vidéo longue en shorts pour les réseaux sociaux, comme OpusClip, sont payants et facturés au mois. Je ne voulais pas m'abonner, donc j'ai construit ClipForge, ma propre version entièrement locale, en m'appuyant sur Ollama pour faire tourner les modèles de langage directement sur ma machine.",
    ...
    image: "/images/projects/clipforge/1.png",
    gallery: [
      "/images/projects/clipforge/1.png",
      "/images/projects/clipforge/2.png",
      "/images/projects/clipforge/3.png",
      "/images/projects/clipforge/4.png",
      "/images/projects/clipforge/5.png",
    ],
  },
  {
